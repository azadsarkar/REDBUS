...
urlpatterns = [
    ...
    path('forgate_password/', auth_views.PasswordResetView.as_view(template_name = "account_reset_pass/reset_password1.html",
        success_url = '/reset_password_sent/'),name ='forgate_password'),
    path('reset_password_sent/', auth_views.PasswordResetDoneView.as_view(template_name = "account_reset_pass/password_reset_sent.html"),
         name ='password_reset_done'),
    path('reset/<uidb64>/<token>', auth_views.PasswordResetConfirmView.as_view(template_name = "account_reset_pass/password_reset_form.html", 
        success_url='/reset_password_complete/'), name ='password_reset_confirm'),
    path('reset_password_complete/', auth_views.PasswordResetCompleteView.as_view(template_name = "account_reset_pass/password_reset_done.html"),
